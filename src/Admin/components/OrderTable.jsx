          ...
          <Table sx={{ minWidth: 650 }} aria-label="simple table">
            <TableHead sx={{
              ...
              <TableRow>
                ...
                <TableCell align="left" sx={{ fontWeight: 'bold' }}>Update</TableCell>
                ...
                orderContent.map((item, index) => (
                  ...
                  >
                    ...
                    <TableCell align='left' scope='row'>
                      {item.items.map((orderItem) => <p>{orderItem.product.title.slice(0,40)}</p>)}
                    </TableCell>
                    ...
                    <TableCell>
                      {item.paymentDetails.paymentMethod === "Cash-On-Delivery" ? "COD" : "ONLINE"}
                    </TableCell>
                    <TableCell>
                      <Button
                        id={`status-button-${item.id}`}
                        aria-controls={open(item.id) ? `menu-${item.id}` : undefined}
                        aria-haspopup="true"
                      ...
                      >
                        <MenuItem onClick={() => handleConfirmOrder(item.id)}>Confirm</MenuItem>
                    ...
                    <TableCell align='left'>
                      <Button
                        variant='contained'
                        sx={{
                          background: 'linear-gradient(45deg, #85e085, #66b2ff)',
                          color: 'white',
                          '&:hover': {
